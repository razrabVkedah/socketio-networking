...
namespace ClientSocketIO.NetworkData.NetworkVariables
{
    ...
    {
        public NetworkVariableColor(Color initialValue, AuthorityMode authorityMode = AuthorityMode.Both,
        ...
        public NetworkVariableColor() : base(new Color())
        {
        }
        ...
        public override void InterpolationUpdate()
        {
            ...
            for (var i = 0; i < States.Count - 1; i++)
            {
                ...
                _variable = Color.Lerp(States[i].Value, States[i + 1].Value, t);
