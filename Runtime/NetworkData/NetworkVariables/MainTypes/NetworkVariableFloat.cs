...
namespace ClientSocketIO.NetworkData.NetworkVariables
{
    ...
    {
        public NetworkVariableFloat(float initialValue, AuthorityMode authorityMode = AuthorityMode.Both,
        ...
        public NetworkVariableFloat() : base(0)
        {
        }
        ...
        public override void InterpolationUpdate()
        {
            ...
            for (var i = 0; i < States.Count - 1; i++)
            {
                ...
                _variable = Mathf.Lerp(States[i].Value, States[i + 1].Value, t);
