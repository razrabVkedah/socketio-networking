...
namespace ClientSocketIO.NetworkData.NetworkVariables
{
    ...
    {
        public NetworkVariableInt(int initialValue, AuthorityMode authorityMode = AuthorityMode.Both,
        ...
        public NetworkVariableInt() : base(0)
        {
        }
        ...
        public override void InterpolationUpdate()
        {
            ...
            for (var i = 0; i < States.Count - 1; i++)
            {
                ...
                _variable = Mathf.RoundToInt(Mathf.Lerp(States[i].Value, States[i + 1].Value, t));
