...
namespace ClientSocketIO.NetworkData.NetworkVariables
{
    ...
    {
        public NetworkVariableVector2(Vector2 initialValue, AuthorityMode authorityMode = AuthorityMode.Both,
        ...
        public NetworkVariableVector2() : base(new Vector2())
        {
        }
        ...
        public override void InterpolationUpdate()
        {
            ...
            for (var i = 0; i < States.Count - 1; i++)
            {
                ...
                _variable = Vector2.Lerp(States[i].Value, States[i + 1].Value, t);
